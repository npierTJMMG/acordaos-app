<template>
    <component
		:class="!vertical ? 'custom-nav-tabs'  : ''"
        :is="layoutComponent"
...
export default {
    ...
    props: {
        ...
        verticalNavClasses: {
            type: [String, Object],
            default: 'col-lg-3 col-md-4 col-sm-12 col-12', //default: 'col-lg-4 col-md-5 col-sm-4 col-6',
            description: 'Vertical tab css classes'
        },
        verticalTabContentClasses: {
            type: [String, Object],
            default: 'col-lg-9 col-md-8 col-sm-12 col-12', // default: 'col-lg-8 col-md-7 col-sm-8 col-6',
